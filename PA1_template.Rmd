...
```{r temp1,echo=TRUE}
setwd('C:\\Users\\ibrahim\\Desktop\\RepData_PeerAssessment1-master')
library(dplyr)
library(ggplot2)
...
print(act.impute$mean.steps[is.na(act.impute$steps)])
...
ct.int.weekday <- group_by(act.weekday, interval)
